...
class DefaultTwoFactorFormRenderer_892ae3f extends \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer8c834 && ($this->initializer8c834->__invoke($valueHolder787d7, $this, 'renderForm', array('request' => $request, 'templateVars' => $templateVars), $this->initializer8c834) || 1) && $this->valueHolder787d7 = $valueHolder787d7;

        return $this->valueHolder787d7->renderForm($request, $templateVars);
    }
    ...
    public function __construct(\Twig\Environment $twigRenderer, string $template, array $templateVars = [])
    {
        ...
        $this->valueHolder787d7->__construct($twigRenderer, $template, $templateVars);
    }
