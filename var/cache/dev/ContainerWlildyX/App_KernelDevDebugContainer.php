...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getCoreCacheHandlerService()
    {
        ...
        $this->services['Pimcore\\Cache\\Core\\CoreCacheHandler'] = $instance = new \Pimcore\Cache\Core\CoreCacheHandler($a, $b, $d);
    ...
    protected function getStaticPageGeneratorService()
    {
        ...
        $b = ($this->services['Pimcore\\Document\\Renderer\\DocumentRenderer'] ?? $this->getDocumentRendererService());

        if (isset($this->services['Pimcore\\Document\\StaticPageGenerator'])) {
            return $this->services['Pimcore\\Document\\StaticPageGenerator'];
        }

        return $this->services['Pimcore\\Document\\StaticPageGenerator'] = new \Pimcore\Document\StaticPageGenerator($b, $a);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'UTF8MB4', 'host' => 'db', 'port' => 3306, 'user' => 'pimcore', 'password' => 'pimcore', 'dbname' => 'pimcore', 'driverOptions' => [1002 => 'SET sql_mode = \'\';'], 'wrapperClass' => '\\Pimcore\\Db\\Connection', 'serverVersion' => '10.7.7-MariaDB-1:10.7.7+maria~ubu2004', 'defaultTableOptions' => ['charset' => 'UTF8MB4', 'engine' => 'InnoDB', 'collate' => 'utf8mb4_general_ci']], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getCookieStorageService()
    {
        ...
        return $this->privates['Pimcore\\Targeting\\Storage\\CookieStorage'] = new \Pimcore\Targeting\Storage\CookieStorage(new \Pimcore\Targeting\Storage\Cookie\JWTCookieSaveHandler('6mNB/fngSNbv7NOBs+57hKq9m2bOiB1fcntfe1na4x4=', [], NULL, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService())), $a);
    }
    ...
    protected function getTwig_Runtime_HttpkernelService()
    {
        ...
        return $this->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('6mNB/fngSNbv7NOBs+57hKq9m2bOiB1fcntfe1na4x4='), $a));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => '6mNB/fngSNbv7NOBs+57hKq9m2bOiB1fcntfe1na4x4=',
            ...
            'kernel.secret' => '6mNB/fngSNbv7NOBs+57hKq9m2bOiB1fcntfe1na4x4=',
