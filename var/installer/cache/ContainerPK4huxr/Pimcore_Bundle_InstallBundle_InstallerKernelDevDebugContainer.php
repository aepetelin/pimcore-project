...
class Pimcore_Bundle_InstallBundle_InstallerKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FX+qKLiAz1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'installer-63b8569ec122d3.16153393',
            ...
            'kernel.secret' => 'installer-63b8569ec122d3.16153393',
